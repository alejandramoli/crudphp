...
$resultado=consulta($miconexion, "select * from usuarios where usua_contra='{$_SESSION['nusuario']}' and usua_contra='{$_SESSION['nclave']}'");
?>
                 ...
                 if ($resultado->num_rows>0)
                    {
                        ...
                        $_SESSION['Tipo_usario']=$fila->usua_tipo;
                    ?>
                    <label class="lgris">Bienveidos<?php echo $_SESSION['nusuario'] ?></label> <br>
